...
TEMPLATE_NORETURN void TemplateLogFatal(const char *restrict file, i32 line, const char *restrict func, const char *restrict fmt, ...) TEMPLATE_PRINTF(4, 5);
#define LOG_FATAL(...) TemplateLogFatal(__FILE__, __LINE__, __func__, __VA_ARGS__)

TEMPLATE_NORETURN void TemplateLogNotImplemented(const char *restrict file, i32 line, const char *restrict func, const char *restrict fmt, ...) TEMPLATE_PRINTF(4, 5);
...
void TemplateLogError(const char *restrict file, i32 line, const char *restrict func, const char *restrict fmt, ...) TEMPLATE_PRINTF(4, 5);
...
void TemplateLogWarning(const char *restrict file, i32 line, const char *restrict func, const char *restrict fmt, ...) TEMPLATE_PRINTF(4, 5);
...
void TemplateLogDeprecated(const char *restrict file, i32 line, const char *restrict func, const char *restrict fmt, ...) TEMPLATE_PRINTF(4, 5);
...
void TemplateLogDebug(const char *restrict file, i32 line, const char *restrict func, const char *restrict fmt, ...) TEMPLATE_PRINTF(4, 5);
...
void TemplateLogTrace(const char *restrict file, i32 line, const char *restrict func, const char *restrict fmt, ...) TEMPLATE_PRINTF(4, 5);
